...
public class ResellerLimitFieldTest extends TestBase{
	...
	public void AddNewResellerClientCommon(String reseller_limit) throws IOException, InterruptedException {
		...
		addNewResellerClient.typeToPasswordInputFieldParam("12345678");// taking input from the password
		...
		addNewResellerClient.typeToresellerLimitInputFieldParam(reseller_limit);// taking input from the Reseller Limit
