...
public class BalanceLimitFieldTest extends TestBase{
	...
	public void AddNewResellerClientCommon(String balance_limit) throws IOException, InterruptedException {
		...
		addNewResellerClient.typeToPasswordInputFieldParam("123456789");// taking input from the password
		addNewResellerClient.typeToCreditLimitInputFieldParam("100");// taking input from the credit limit
		...
		addNewResellerClient.typeTobalanceLimitInputFieldParam(balance_limit);// taking input from the Balance Limit
	...
	public void enter_then_undo_and_redo_the_input_action_into_balance_limit_input_field() throws IOException, InterruptedException{
		...
		addNewResellerClient.typeToPasswordInputFieldParam("1111111111111111111");// taking input from the password
		addNewResellerClient.typeAndClearPasswordInputFieldParam("");
		addNewResellerClient.typeToPasswordInputFieldParam("1111111111111111111");
		addNewResellerClient.typeToCreditLimitInputFieldParam("1000");// taking input from the credit limit
		addNewResellerClient.searchandtypeelementDropDownIPBundleField();// select inputs data form the IP Bundle drop down field
		addNewResellerClient.searchandtypeelementDropDownIPBundle2Field();//select inputs data form the IP Bundle 2  drop down field
		addNewResellerClient.ratePlaneelementDropDownField();// select inputs data form the Rate Plan drop down field
