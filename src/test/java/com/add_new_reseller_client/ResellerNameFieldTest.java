...
public class ResellerNameFieldTest extends TestBase{
	...
	public void AddNewResellerClientCommon(String reseller_name) throws IOException, InterruptedException {
		...
		addNewResellerClient.typeToResellerNameInputFieldParam(reseller_name);//taking input from the reseller Name
	...
	//@Test(priority=2)
	public void enter_a_valid_text_into_reseller_name_input_field() throws IOException, InterruptedException {AddNewResellerClientCommon("url for iOS");	}
	//@Test(priority=3)
	...
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_reseller_name_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("           ani1yr"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_reseller_name_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("abc1yr                   ");}
	//@Test(priority=11)
	...
	public void enter_text_and_navigate_through_into_iOS_onclick_URL_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		addNewResellerClient.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
		addNewResellerClient.typeToResellerNameInputFieldParam("khan VPN reseller");//taking input from the reseller Name
		addNewResellerClient.typetoResellerNameInputFieldtabKey();
		addNewResellerClient.typeTologinInputFieldParam("ani.kolpolok@gmail.com");// taking input from the login
		addNewResellerClient.typeToPasswordInputFieldParam("1111111111111111111");// taking input from the password
		addNewResellerClient.typeToCreditLimitInputFieldParam("1000");// taking input from the credit limit
		addNewResellerClient.searchandtypeelementDropDownIPBundleField();// select inputs data form the IP Bundle drop down field
