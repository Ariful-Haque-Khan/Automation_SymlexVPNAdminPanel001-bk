...
public class AddressFieldTest extends TestBase{
	...
	public void AddNewResellerClientCommon(String address) throws IOException, InterruptedException {
		...
		resellerClient_AffiliatorClientElement.typeToaddressInputFieldParam(address);// taking input from the address
	...
	//@Ignore
	//@Test(priority=1)
	public void enter_empty_text_into_address_input_field() throws IOException, InterruptedException {AddNewResellerClientCommon("");	}
	@Test(priority=2)
	public void enter_a_valid_text_into_address_input_field() throws IOException, InterruptedException {AddNewResellerClientCommon("1000");	}
	//@Test(priority=3)
	public void enter_the_above_maximum_allowed_length_of_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("");}
	//@Test(priority=4)
	public void enter_the_below_minimum_allowed_length_of_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("a");}
	//@Test(priority=5)
	public void enter_only_alphabetic_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("abcdefgh");}
	//@Test(priority=6)
	public void enter_numeric_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("123456789123456789");}
	//@Test(priority=7)
	public void enter_a_combination_of_alphabetic_and_numeric_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("abc1234567abc");}
	//@Test(priority=8)
	public void enter_special_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("           ani1yr"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("abc1yr                   ");}
	//@Test(priority=11)
	public void enter_text_in_uppercase_letters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("asdfghjkzxcvbnm");}
	//@Test(priority=12)
	public void enter_text_in_lowercases_letters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("anianiani");}
	//@Test(priority=13)
	public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("ABCdefasASD"); }
	//@Test(priority=14)
	public void enter_text_with_punctuation_marks_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon(",./;?.,;/.,./?><:;,./;.,"); }
	//@Test(priority=15)
	public void enter_text_with_line_breaks_or_newlines_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
				+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
	//@Test(priority=16)
	public void enter_text_with_unicode_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("こんにちは"); }
	//@Test(priority=17)
	public void enter_text_containing_emojis_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("😊, 🐱, 🍕, 🎉"); }
	//@Test(priority=18)
	public void enter_text_with_accented_characters_into_address_input_field() throws IOException, InterruptedException{AddNewResellerClientCommon("á, ç, ō,  á, ç, ō");}
	//@Test(priority=19)
	public void enter_default_placeholder_text_into_address_input_field() throws IOException, InterruptedException{ 
			
	}

	//@Test(priority=21)
	public void enter_then_clear_the_text_into_address_input_field() throws IOException, InterruptedException{
		resellerClient_AffiliatorClientElement = loginPage.addNewResellerClientLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		resellerClient_AffiliatorClientElement.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
	...
	//@Test(priority=22)
	public void enter_then_undo_the_input_action_into_address_input_field() throws IOException, InterruptedException{
		resellerClient_AffiliatorClientElement = loginPage.addNewResellerClientLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		resellerClient_AffiliatorClientElement.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
		resellerClient_AffiliatorClientElement.typeToResellerNameInputFieldParam("khan VPN reseller");//taking input from the reseller Name
		resellerClient_AffiliatorClientElement.typeTologinInputFieldParam("ani.kolpolok@gmail.com");// taking input from the login
	...
	//@Test(priority=23)
	public void enter_then_undo_and_redo_the_input_action_into_password_input_field() throws IOException, InterruptedException{
		resellerClient_AffiliatorClientElement = loginPage.addNewResellerClientLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		resellerClient_AffiliatorClientElement.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
		resellerClient_AffiliatorClientElement.typeToResellerNameInputFieldParam("khan VPN reseller");//taking input from the reseller Name
		resellerClient_AffiliatorClientElement.typeTologinInputFieldParam("ani.kolpolok@gmail.com");// taking input from the login
	...
	//@Test(priority=24)
	//@Ignore
	public void enter_text_and_navigate_through_into_address_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		resellerClient_AffiliatorClientElement = loginPage.addNewResellerClientLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		resellerClient_AffiliatorClientElement.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
		resellerClient_AffiliatorClientElement.typeToResellerNameInputFieldParam("khan VPN reseller");//taking input from the reseller Name
		resellerClient_AffiliatorClientElement.typeTologinInputFieldParam("ani.kolpolok@gmail.com");// taking input from the login
	...
	//@Test(priority=25)
	public void paste_the_text_into_address_input_field_using_the_paste_action() throws IOException, InterruptedException{
		resellerClient_AffiliatorClientElement = loginPage.addNewResellerClientLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		resellerClient_AffiliatorClientElement.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
		resellerClient_AffiliatorClientElement.typeToResellerNameInputFieldParam("khan VPN reseller");//taking input from the reseller Name
