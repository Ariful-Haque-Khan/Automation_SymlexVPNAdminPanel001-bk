...
public class AddressFieldTest extends TestBase{
	...
	public void AddNewResellerClientCommon(String address) throws IOException, InterruptedException {
		...
		addNewResellerClient.typeToPasswordInputFieldParam("");// taking input from the password
		...
		addNewResellerClient.typeToaddressInputFieldParam(address);// taking input from the address
