...
public class ServerNameFieldTest extends TestBase{
	...
	public void addNewServerCommon(String Server_Name) throws IOException, InterruptedException {
	...
	//@Test(priority=4)
	public void enter_the_below_minimum_allowed_length_of_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("a");}
	//@Test(priority=5)
	public void enter_only_alphabetic_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("abcdefgh");}
	//@Test(priority=6)
	public void enter_numeric_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("123456789123456789");}
	//@Test(priority=7)
	public void enter_a_combination_of_alphabetic_and_numeric_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("abc1234567abc");}
	//@Test(priority=8)
	public void enter_special_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("           TEST SERVER"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("TEST SERVER                 ");}
	//@Test(priority=11)
	public void enter_text_in_uppercase_letters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("TEST SERVER");}
	//@Test(priority=12)
	public void enter_text_in_lowercases_letters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("anianiani");}
	//@Test(priority=13)
	public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("ABCdefasASD"); }
	//@Test(priority=14)
	public void enter_text_with_punctuation_marks_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon(",./;?.,;/.,./?><:;,./;.,"); }
	//@Test(priority=15)
	public void enter_text_with_line_breaks_or_newlines_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
				+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
	//@Test(priority=16)
	public void enter_text_with_unicode_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("こんにちは"); }
	//@Test(priority=17)
	public void enter_text_containing_emojis_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("😊, 🐱, 🍕, 🎉"); }
	//@Test(priority=18)
	public void enter_text_with_accented_characters_into_Server_Name_input_field() throws IOException, InterruptedException{addNewServerCommon("á, ç, ō,  á, ç, ō");}
	...
	public void enter_then_clear_the_text_into_Server_Name_input_field() throws IOException, InterruptedException{
		...
		serverModuleElement.typeAndClearServerNameFieldParam("");//clear the text
		serverModuleElement.typeToIPFieldParam("100.000.121.00");// taking input from the IP
		serverModuleElement.typeToIPRangeFieldParam("100.000.121.001");// taking input from the IP Range
		serverModuleElement.typeToPathFieldParam("abc-120");// taking input from the Path
		serverModuleElement.typeToCapacityFieldParam("2000");// taking input from the Capacity
	...
	public void enter_then_undo_and_redo_the_input_action_into_Server_Name_input_field() throws IOException, InterruptedException{
		...
		serverModuleElement.typeToServerNameFieldParam("test server");//taking input from Server Name
		serverModuleElement.typeAndClearServerNameFieldParam("");//undo the text
		serverModuleElement.typeToServerNameFieldParam("test server");//redo the text
		serverModuleElement.typeToIPFieldParam("100.000.121.00");// taking input from the IP
		serverModuleElement.typeToIPRangeFieldParam("100.000.121.001");// taking input from the IP Range
		serverModuleElement.typeToPathFieldParam("abc-120");// taking input from the Path
		serverModuleElement.typeToCapacityFieldParam("2000");// taking input from the Capacity
	...
	public void enter_text_and_navigate_through_into_Server_Name_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		serverModuleElement.openAddNewServerPage();// open the Add New server Form Page.
		serverModuleElement.typeToServerNameFieldParam("test server");//taking input from Server Name
		serverModuleElement.typetoServerNametabKey();//navigate to the tab key
		serverModuleElement.typeToIPFieldParam("100.000.121.00");// taking input from the IP
		serverModuleElement.typeToIPRangeFieldParam("100.000.121.001");// taking input from the IP Range
		serverModuleElement.typeToPathFieldParam("abc-120");// taking input from the Path
		serverModuleElement.typeToCapacityFieldParam("2000");// taking input from the Capacity
