...
public class EditIPInputFieldTest extends TestBase{
	...
	public void editIPCommon(String IP) throws IOException, InterruptedException {
	...
	//@Ignore
	//@Test(priority=1)
	public void enter_empty_text_into_IP_input_field() throws IOException, InterruptedException {editIPCommon("");	}
	//@Test(priority=2)
	public void enter_a_valid_text_into_IP_input_field() throws IOException, InterruptedException {editIPCommon("1000.1000.10001.0001");	}
	//@Test(priority=3)
	...
	//@Test(priority=4)
	public void enter_the_below_minimum_allowed_length_of_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("a");}
	//@Test(priority=5)
	public void enter_only_alphabetic_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("abcdefgh");}
	//@Test(priority=6)
	public void enter_numeric_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("123456789123456789");}
	//@Test(priority=7)
	public void enter_a_combination_of_alphabetic_and_numeric_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("abc1234567abc");}
	//@Test(priority=8)
	public void enter_special_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("          1000.1000.10001.0001"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("1000.1000.10001.0001                   ");}
	//@Test(priority=11)
	public void enter_text_in_uppercase_letters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("asdfghjkzxcvbnm");}
	//@Test(priority=12)
	public void enter_text_in_lowercases_letters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("anianiani");}
	//@Test(priority=13)
	public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("ABCdefasASD"); }
	//@Test(priority=14)
	public void enter_text_with_punctuation_marks_into_IP_input_field() throws IOException, InterruptedException{editIPCommon(",./;?.,;/.,./?><:;,./;.,"); }
	//@Test(priority=15)
	public void enter_text_with_line_breaks_or_newlines_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
				+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
	//@Test(priority=16)
	public void enter_text_with_unicode_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("こんにちは"); }
	//@Test(priority=17)
	public void enter_text_containing_emojis_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("😊, 🐱, 🍕, 🎉"); }
	//@Test(priority=18)
	public void enter_text_with_accented_characters_into_IP_input_field() throws IOException, InterruptedException{editIPCommon("á, ç, ō,  á, ç, ō");}
	//@Test(priority=19)
	...
	public void enter_then_undo_the_input_action_into_IP_input_field() throws IOException, InterruptedException{
		...
		iPListElement.typeToServerNameFieldParam("");//taking input from the server Name
		Thread.sleep (3000);
		iPListElement.typeAndClearIPFieldParam("");//undo the text
		Thread.sleep (3000);
		iPListElement.typeToNoteInputFieldParam("");// taking input from the note
		iPListElement.typeSelectField();// select inputs data form the type of protocol dropdown field
		iPListElement.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
	...
	//@Test(priority=24)
	//@Ignore
	public void enter_text_and_navigate_through_into_IP_input_fieldd_using_the_tab_key() throws IOException, InterruptedException{ 
		iPListElement = loginPage.addNewIPLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		driver.get("https://adminportal.symlexvpn.com/vpnadmin/index.php/ip/editForm/1392/0/100");// open the edit Server Form Page.
		iPListElement.typeToServerNameFieldParam("");//taking input from the server Name
		iPListElement.typeToIPInputFieldParam(".100");// taking input from the ip
	...
	public void paste_the_text_into_IP_input_field_using_the_paste_action() throws IOException, InterruptedException{
		...
		iPListElement.typeToIPInputFieldParam(".1000");// taking input from the ip
		iPListElement.typeToNoteInputFieldParam(".Server is down");// taking input from the note
		iPListElement.typeSelectField();// select inputs data form the type of protocol dropdown field
		iPListElement.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
		iPListElement.uaeNetworkSelectField();//select inputs data form the UAE Network drop down field
