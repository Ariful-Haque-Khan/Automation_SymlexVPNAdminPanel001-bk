...
public class TitleFieldTest extends TestBase{
	...
	public void SendPushtoUserCommon(String title) throws IOException, InterruptedException {
		...
		sendPushtoUser.typetotitleInputFieldParam(title);// taking input from the title input field  
		sendPushtoUser.typetomessageInputFieldFieldParam("message oe the push");// taking inputs from the message input text field 
		...
		//@Ignore
		//@Test(priority=1)
		public void enter_empty_text_into_title_input_field() throws IOException, InterruptedException {SendPushtoUserCommon("");	}
		//@Test(priority=2)
		public void enter_a_valid_text_into_title_input_field() throws IOException, InterruptedException {SendPushtoUserCommon("title of the push");	}
		//@Test(priority=3)
		...
		//@Test(priority=4)
		public void enter_the_below_minimum_allowed_length_of_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("a");}
		//@Test(priority=5)
		public void enter_only_alphabetic_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("abcdefgh");}
		//@Test(priority=6)
		public void enter_numeric_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("123456789123456789");}
		//@Test(priority=7)
		public void enter_a_combination_of_alphabetic_and_numeric_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("abc1234567abc");}
		//@Test(priority=8)
		public void enter_special_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
		//@Test(priority=9)
		public void enter_text_with_leading_whitespaces_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("           ani1yr"); }
		//@Test(priority=10)
		public void enter_text_with_trailing_whitespaces_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("abc1yr                   ");}
		//@Test(priority=11)
		public void enter_text_in_uppercase_letters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("asdfghjkzxcvbnm");}
		//@Test(priority=12)
		public void enter_text_in_lowercases_letters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("anianiani");}
		//@Test(priority=13)
		public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("ABCdefasASD"); }
		//@Test(priority=14)
		public void enter_text_with_punctuation_marks_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon(",./;?.,;/.,./?><:;,./;.,"); }
		//@Test(priority=15)
		public void enter_text_with_line_breaks_or_newlines_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
					+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
		//@Test(priority=16)
		public void enter_text_with_unicode_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("こんにちは"); }
		//@Test(priority=17)
		public void enter_text_containing_emojis_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("😊, 🐱, 🍕, 🎉"); }
		//@Test(priority=18)
		public void enter_text_with_accented_characters_into_title_input_field() throws IOException, InterruptedException{SendPushtoUserCommon("á, ç, ō,  á, ç, ō");}
		//@Test(priority=19)
		...
		public void enter_text_then_clear_the_input_text_field() throws IOException, InterruptedException{
			...
			sendPushtoUser.typeAndClearthetitleInputFieldParam(""); //clear the text
		...
		//@Test(priority=21)
		public void enter_then_undo_the_input_action_into_title_input_field() throws IOException, InterruptedException{
			sendPushtoUser = loginPage.sendPushtoUserLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
			sendPushtoUser.openSendPushtoUserPage();// open the send push to user Form Page.
			sendPushtoUser.selectDatafromAppNameDropDownElement();//select inputs data form the app name drop down field
			sendPushtoUser.datafromWithChildDropDownElement();// for with child check box
			...
			sendPushtoUser.selectDatafromCopyTemplateDropDownElement();//  select inputs data form the copy template drop down field 
			sendPushtoUser.typetotitleInputFieldParam("title for the push");// taking input from the title input field  
			sendPushtoUser.typeAndClearthetitleInputFieldParam(""); // undo the text
		...
		@Test(priority=22)
		public void enter_then_undo_then_redo_the_input_action_into_title_input_field() throws IOException, InterruptedException{
			sendPushtoUser = loginPage.sendPushtoUserLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
			sendPushtoUser.openSendPushtoUserPage();// open the send push to user Form Page.
			sendPushtoUser.selectDatafromAppNameDropDownElement();//select inputs data form the app name drop down field
			sendPushtoUser.datafromWithChildDropDownElement();// for with child check box
		...
		//@Test(priority=23)
		//@Ignore
		public void enter_text_and_navigate_through_into_title_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
			sendPushtoUser = loginPage.sendPushtoUserLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
			sendPushtoUser.openSendPushtoUserPage();// open the send push to user Form Page.
			sendPushtoUser.selectDatafromAppNameDropDownElement();//select inputs data form the app name drop down field
			sendPushtoUser.datafromWithChildDropDownElement();// for with child check box
			...
			sendPushtoUser.selectDatafromCopyTemplateDropDownElement();//  select inputs data form the copy template drop down field 
			sendPushtoUser.typetotitleInputFieldParam("title for the push");// taking input from the title input field  
			sendPushtoUser.typetothetitleInputFieldTabKey(); // navigate the tab key
			sendPushtoUser.typetomessageInputFieldFieldParam("message for the push");// taking inputs from the message input text field 
			sendPushtoUser.imageURLInputFieldFieldParam("https://www.filepicker.io/api/file/FBrysv8XTuqjv42J23Qi?filename=name.jpg");// taking inputs from the image url input text field taking inputs from the url for android input text field
			sendPushtoUser.urlforAndroidInputFieldFieldParam("https://www.filepicker.io/api/file/FBrysv8XTuqjv42J23Qi?filename=name.jpg");// taking inputs from the url for android input text field  taking inputs from the url for ios input text field
			sendPushtoUser.urlforiOSInputFieldFieldParam("https://www.filepicker.io/api/file/FBrysv8XTuqjv42J23Qi?filename=name.jpg");//taking inputs from the url for ios input text field  
		...
		//@Test(priority=24)
		public void paste_the_text_into_title_input_field_using_the_paste_action() throws IOException, InterruptedException{
			sendPushtoUser = loginPage.sendPushtoUserLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
			sendPushtoUser.openSendPushtoUserPage();// open the send push to user Form Page.
			sendPushtoUser.selectDatafromAppNameDropDownElement();//select inputs data form the app name drop down field
			sendPushtoUser.datafromWithChildDropDownElement();// for with child check box
