...
public class ResellerNameEditInputFieldTest extends TestBase{
	...
	public ResellerNameEditInputFieldTest() {
	...
	public void EditResellerClientCommon(String reseller_name) throws IOException, InterruptedException {
		...
		driver.get("https://adminportal.symlexvpn.com/vpnadmin/index.php/reseller/editFormReseller4/247/0/0/100"); //open the Edit Reseller Client Form Page.
		resellerClient_AffiliatorClientElement.typeAndClearResellerNameInputFieldParam("");
		resellerClient_AffiliatorClientElement.typeToResellerNameInputFieldParam(reseller_name);//taking input from the reseller Name
		//resellerClient_AffiliatorClientElement.typeTologinInputFieldParam("ani.kolpolok@gmail.com");// taking input from the login
		resellerClient_AffiliatorClientElement.typeToPasswordInputFieldParam("");// taking input from the password
		...
		resellerClient_AffiliatorClientElement.typeToBrandNameInputFieldParam("");//  taking inputs from brand name input field
		...
		resellerClient_AffiliatorClientElement.typeToIsCustomizePanelPanelNameFieldParam("");// taking input from the panel name
		...
		resellerClient_AffiliatorClientElement.typeTonumberOfDevicesInputFieldParam("");// taking input from theNumber Of Devices
		resellerClient_AffiliatorClientElement.typeToresellerLimitInputFieldParam("");// taking input from the Reseller Limit
		resellerClient_AffiliatorClientElement.typeTobalanceLimitInputFieldParam("");// taking input from the Balance Limit
		resellerClient_AffiliatorClientElement.typeToemailInputFieldFieldParam("");// taking input from the Email
		resellerClient_AffiliatorClientElement.typeTophoneNoInputFieldEParam("");// taking input from the phone no
	...
	//@Ignore
	//@Test(priority=1)
	public void enter_empty_text_into_reseller_name_input_field() throws IOException, InterruptedException {EditResellerClientCommon("");	}
	@Test(priority=2)
	public void enter_a_valid_text_into_reseller_name_input_field() throws IOException, InterruptedException {EditResellerClientCommon("Rumy QA");	}
	//@Test(priority=3)
	public void enter_the_above_maximum_allowed_length_of_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("");}
	//@Test(priority=4)
	public void enter_the_below_minimum_allowed_length_of_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("a");}
	//@Test(priority=5)
	public void enter_only_alphabetic_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("abcdefgh");}
	//@Test(priority=6)
	public void enter_numeric_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("123456789123456789");}
	//@Test(priority=7)
	public void enter_a_combination_of_alphabetic_and_numeric_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("abc1234567abc");}
	//@Test(priority=8)
	public void enter_special_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("           Rumy QA"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("Rumy QA                  ");}
	//@Test(priority=11)
	public void enter_text_in_uppercase_letters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("asdfghjkzxcvbnm");}
	//@Test(priority=12)
	public void enter_text_in_lowercases_letters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("anianiani");}
	//@Test(priority=13)
	public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("ABCdefasASD"); }
	//@Test(priority=14)
	public void enter_text_with_punctuation_marks_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon(",./;?.,;/.,./?><:;,./;.,"); }
	//@Test(priority=15)
	public void enter_text_with_line_breaks_or_newlines_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
				+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
	//@Test(priority=16)
	public void enter_text_with_unicode_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("こんにちは"); }
	//@Test(priority=17)
	public void enter_text_containing_emojis_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("😊, 🐱, 🍕, 🎉"); }
	//@Test(priority=18)
	public void enter_text_with_accented_characters_into_reseller_name_input_field() throws IOException, InterruptedException{EditResellerClientCommon("á, ç, ō,  á, ç, ō");}
	//@Test(priority=19)
	public void enter_default_placeholder_text_into_reseller_name_input_field() throws IOException, InterruptedException{ 
	...
	public void enter_text_and_navigate_through_into_iOS_onclick_URL_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		resellerClient_AffiliatorClientElement.openaddNewResellerForm();// open the Add New Reseller Client  Form Page.
		resellerClient_AffiliatorClientElement.typeToResellerNameInputFieldParam("khan VPN reseller");//taking input from the reseller Name
		resellerClient_AffiliatorClientElement.typetoResellerNameInputFieldtabKey();
		resellerClient_AffiliatorClientElement.typeTologinInputFieldParam("ani.kolpolok@gmail.com");// taking input from the login
		resellerClient_AffiliatorClientElement.typeToPasswordInputFieldParam("1111111111111111111");// taking input from the password
		resellerClient_AffiliatorClientElement.typeToCreditLimitInputFieldParam("1000");// taking input from the credit limit
		resellerClient_AffiliatorClientElement.searchandtypeelementDropDownIPBundleField();// select inputs data form the IP Bundle drop down field
