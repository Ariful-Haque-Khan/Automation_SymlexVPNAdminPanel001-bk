...
public class ServerNameFieldTest extends TestBase{
	...
	public void addNewIPCommon(String server_name) throws IOException, InterruptedException {
		...
		addNewIP.typeToServerNameFieldParam(server_name);//taking input from the server Name
	...
	public void enter_then_clear_the_text_into_server_name_input_field() throws IOException, InterruptedException{
		...
		addNewIP.typeAndClearServerNameFieldParam("");//clear the text
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");// taking input from the ip
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
	...
	public void enter_then_undo_the_input_action_into_server_name_input_field() throws IOException, InterruptedException{
		...
		addNewIP.openAddNewIPForm();// open the Add New IP  Form Page.
		addNewIP.typeToServerNameFieldParam("test ams-18 ");//taking input from the server Name
		addNewIP.typeAndClearServerNameFieldParam("");// undo the text
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");// taking input from the ip
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
	...
	public void enter_then_undo_and_redo_the_input_action_into_server_name_input_field() throws IOException, InterruptedException{
		...
		addNewIP.typeToServerNameFieldParam("test ams-18 ");//taking input from the server Name
		addNewIP.typeAndClearServerNameFieldParam("");//undo the text
		addNewIP.typeToServerNameFieldParam("test ams-18 "); //redo the text
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");// taking input from the ip
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
	...
	public void enter_text_and_navigate_through_into_server_name_input_fieldd_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		addNewIP.openAddNewIPForm();// open the Add New IP  Form Page.
		addNewIP.typeToServerNameFieldParam("test ams-18 ");//taking input from the server Name
		addNewIP.typetoServerNameFieldtabKey();
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");// taking input from the ip
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
	...
	public void paste_the_text_into_server_name_input_field_using_the_paste_action() throws IOException, InterruptedException{
		...
		addNewIP.openAddNewIPForm();// open the Add New IP  Form Page.
		addNewIP.typeToServerNameFieldParam("test ams-18 ");//taking input from the server Name
		addNewIP.typeAndClearServerNameFieldParam("");
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");// taking input from the ip
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
