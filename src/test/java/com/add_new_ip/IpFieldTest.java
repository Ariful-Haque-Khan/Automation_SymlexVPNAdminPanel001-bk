...
public class IpFieldTest extends TestBase{
	...
	public void addNewIPCommon(String IP) throws IOException, InterruptedException {
		...
		addNewIP.typeToIPInputFieldParam(IP);// taking input from the ip
	...
	public void enter_then_clear_the_text_into_IP_input_field() throws IOException, InterruptedException{
		...
		addNewIP.typeAndClearIPFieldParam("");//clear the text
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
		addNewIP.uaeNetworkSelectField();//select inputs data form the UAE Network drop down field
	...
	public void enter_then_undo_and_redo_the_input_action_into_IP_input_field() throws IOException, InterruptedException{
		...
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");// taking input from the ip
		addNewIP.typeAndClearIPFieldParam("");//clear the text
		addNewIP.typeToIPInputFieldParam("100.000.23..1000");//REDO THE TEXT
		addNewIP.typeToNoteInputFieldParam("server is down");// taking input from the note
		addNewIP.typeSelectField();// select inputs data form the type of protocol dropdown field
		addNewIP.transmissionprotocolSelectField();// select inputs data form the Transmission Protocol drop down field
		addNewIP.uaeNetworkSelectField();//select inputs data form the UAE Network drop down field
