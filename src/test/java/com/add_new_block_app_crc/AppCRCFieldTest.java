...
public class AppCRCFieldTest extends TestBase{
	...
	AddNewBlockAppCRC addNewBlockAppCRC;
	...
	public void addNewBlockAppCRCCommon(String App_CRC) throws IOException, InterruptedException {
		...
		addNewBlockAppCRC.typeDomainNameFieldParam(App_CRC);//taking input from the APP CRC
	...
	public void enter_then_clear_the_text_into_coupon_code_input_field() throws IOException, InterruptedException{
		addNewBlockAppCRC = loginPage.addNewBlockAppCRCLogin(props.getProperty("username"),props.getProperty("password")); //login to the system
		addNewBlockAppCRC.openAddNewBlockAppCRCForm();// open the Add New (Block App CRC) Page.
		addNewBlockAppCRC.typeDomainNameFieldParam("");//taking input from the APP CRC
		addNewBlockAppCRC.typeAndClearDomainNameFieldParam("");//clear the text
		//addNewSignUpBlacklistDomain.clickONSubmitButton();// click on save button
	...
	public void enter_then_undo_the_input_action_into_coupon_code_input_field() throws IOException, InterruptedException{
		...
		addNewBlockAppCRC.openAddNewBlockAppCRCForm();// open the Add New (Block App CRC) Page.
		addNewBlockAppCRC.typeDomainNameFieldParam("");//taking input from the APP CRC
		addNewBlockAppCRC.typeAndClearDomainNameFieldParam("");//undo the text
		//addNewSignUpBlacklistDomain.clickONSubmitButton();// click on save button
	...
	public void enter_then_undo_and_redo_the_input_action_into_coupon_code_input_field() throws IOException, InterruptedException{
		...
		addNewBlockAppCRC.typeDomainNameFieldParam("");//taking input from the APP CRC
		addNewBlockAppCRC.typeAndClearDomainNameFieldParam("");//undo the text
		addNewBlockAppCRC.typeDomainNameFieldParam("");//redo the text
		//addNewSignUpBlacklistDomain.clickONSubmitButton();// click on save button
	...
	public void enter_text_and_navigate_through_into_coupon_code_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		addNewBlockAppCRC.openAddNewBlockAppCRCForm();// open the Add New (Block App CRC) Page.
		addNewBlockAppCRC.typeDomainNameFieldParam("");//taking input from the APP CRC
		addNewBlockAppCRC.typetoDomainNametabKey();//navigate to the tab key
		//addNewSignUpBlacklistDomain.clickONSubmitButton();// click on save button
	}
