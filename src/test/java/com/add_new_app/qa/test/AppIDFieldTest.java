...
public class AppIDFieldTest extends TestBase{
	...
	//@Test(priority=4)
	public void enter_the_below_minimum_allowed_length_of_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("a");}
	//@Test(priority=5)
	public void enter_only_alphabetic_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("abcdefgh");}
	//@Test(priority=6)
	public void enter_numeric_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("123456789123456789");}
	//@Test(priority=7)
	public void enter_a_combination_of_alphabetic_and_numeric_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("M2QxMzQ3YjktYzg3NS00YmMyLWJmZjItNDk4Njlh");}
	@Test(priority=8)
	public void enter_special_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("                  VPNTest123"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("VPNTest123                            ");}
	//@Test(priority=11)
	public void enter_text_in_uppercase_letters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("AAASDFGHJHGFDFGH");}
	//@Test(priority=12)
	public void enter_text_in_lowercases_letters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("anianiani");}
	//@Test(priority=13)
	public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("ABCdefasASD"); }
	//@Test(priority=14)
	public void enter_text_with_punctuation_marks_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon(",./;?.,;/.,./?><:;,./;.,"); }
	//@Test(priority=15)
	public void enter_text_with_line_breaks_or_newlines_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
				+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
	//@Test(priority=16)
	public void enter_text_with_unicode_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("こんにちは"); }
	//@Test(priority=17)
	public void enter_text_containing_emojis_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("😊, 🐱, 🍕, 🎉"); }
	//@Test(priority=18)
	public void enter_text_with_accented_characters_into_App_ID_input_field() throws IOException, InterruptedException{CreateNewAppCommon("á, ç, ō,  á, ç, ō");}
	//@Test(priority=19)
	public void enter_default_placeholder_text_into_App_ID_input_field() throws IOException, InterruptedException{
