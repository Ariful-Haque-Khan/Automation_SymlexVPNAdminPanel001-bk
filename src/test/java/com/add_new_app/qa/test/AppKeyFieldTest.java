...
public class AppKeyFieldTest extends TestBase{
	...
	public void enter_default_placeholder_text_into_App_key_input_field() throws IOException, InterruptedException{
		...
		public void enter_text_then_clear_the_input_text_field()throws IOException,InterruptedException  {
			...
			appListElement.typeToAPPIDOneSignalTestParam("883da8da-ba2e-4966-a025-d1a2483");//for taking inputs into the app id field
			...
			appListElement.typeAndClearAppKeyInputField("");// clear the key field
			appListElement.clickToIsUDIDCheckChekboxInputTest();//for clicking UDID check box
			//appListElement.clickToSaveButtonTest(); //for the save button
		...
		public void enter_then_undo_the_input_action_into_the_app_key_field()throws IOException,InterruptedException  {
			...
			appListElement.typeToAPPIDOneSignalTestParam("883da8da-ba2e-4966-a025-d1a2483");//for taking inputs into the app id field
			appListElement.typeToAPPKeyOneSignalTestParam("M2QxMzQ3YjktYzg3NS00YmMyLWJmZjItNDk4Njl");//for taking inputs into the app key field
			appListElement.typeAndClearAppKeyInputField("");//UNDO the key field
			appListElement.clickToIsUDIDCheckChekboxInputTest();//for clicking UDID check box
			//appListElement.clickToSaveButtonTest(); //for the save button
		...
		public void enter_then_undo_then_redo_the_input_action_into_the_app_key_field() throws IOException,InterruptedException  {
			...
			appListElement.typeToAPPKeyOneSignalTestParam("M2QxMzQ3YjktYzg3NS00YmMyLWJmZjItNDk4Njl");//for taking inputs into the app key field
			appListElement.typeAndClearAppKeyInputField("");// clear the key field
			appListElement.typeToAPPKeyOneSignalTestParam("M2QxMzQ3YjktYzg3NS00YmMyLWJmZjItNDk4Njl");//REDO THE TEXT
			appListElement.clickToIsUDIDCheckChekboxInputTest();//for clicking UDID check box
			//appListElement.clickToSaveButtonTest(); //for the save button
