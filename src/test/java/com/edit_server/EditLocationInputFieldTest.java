...
public class EditLocationInputFieldTest extends TestBase{
	...
	public EditLocationInputFieldTest() {
	...
	public void editServerCommon(String Location) throws IOException, InterruptedException {
	...
	//@Ignore
	//@Test(priority=1)
	public void enter_empty_text_into_Location_input_field() throws IOException, InterruptedException {editServerCommon("");	}
	@Test(priority=2)
	public void enter_a_valid_text_into_Location_input_field() throws IOException, InterruptedException {editServerCommon("Metropolitan area");	}
	//@Test(priority=3)
	...
	//@Test(priority=4)
	public void enter_the_below_minimum_allowed_length_of_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("a");}
	//@Test(priority=5)
	public void enter_only_alphabetic_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("abcdefgh");}
	//@Test(priority=6)
	public void enter_numeric_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("123456789123456789");}
	//@Test(priority=7)
	public void enter_a_combination_of_alphabetic_and_numeric_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("abc1234567abc");}
	//@Test(priority=8)
	public void enter_special_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("!@#$%^&*!@#$%^&*@!@#$%^&"); }
	//@Test(priority=9)
	public void enter_text_with_leading_whitespaces_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("           Metropolitan area"); }
	//@Test(priority=10)
	public void enter_text_with_trailing_whitespaces_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("Metropolitan area                ");}
	//@Test(priority=11)
	public void enter_text_in_uppercase_letters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("TEST SERVER");}
	//@Test(priority=12)
	public void enter_text_in_lowercases_letters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("anianiani");}
	//@Test(priority=13)
	public void enter_text_with_a_mix_of_uppercase_and_lowercase_letter_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("ABCdefasASD"); }
	//@Test(priority=14)
	public void enter_text_with_punctuation_marks_into_Location_input_field() throws IOException, InterruptedException{editServerCommon(",./;?.,;/.,./?><:;,./;.,"); }
	//@Test(priority=15)
	public void enter_text_with_line_breaks_or_newlines_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("\\\\\"ANI1yr\\\\\\\\n\\\\\\\" +\\\\r\\\\n\\\"\\r\\n\"\r\n"
				+ "				+ \"				+ \\\"                                  \\\\\\\"ani1yr\\\\\\\""); }
	//@Test(priority=16)
	public void enter_text_with_unicode_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("こんにちは"); }
	//@Test(priority=17)
	public void enter_text_containing_emojis_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("😊, 🐱, 🍕, 🎉"); }
	//@Test(priority=18)
	public void enter_text_with_accented_characters_into_Location_input_field() throws IOException, InterruptedException{editServerCommon("á, ç, ō,  á, ç, ō");}
	...
	public void enter_then_undo_and_redo_the_input_action_into_Location_input_field() throws IOException, InterruptedException{
		...
		serverModuleElement.typeAndClearLocationFieldParam("");//UNDO the text
		Thread.sleep (3000);
		serverModuleElement.typeToLocationFieldParam("Metropolitan area");//redo the text
		Thread.sleep (3000);
		serverModuleElement.typeToOrderPriorityFieldParam("1");//  taking input from the Order Priority
		serverModuleElement.typeToServerPriceFieldParam("");//taking input from the Server Price $
		serverModuleElement.typeAndClearDomainFieldParam("");
