...
public class DescriptionFieldTest extends TestBase{
	...
	public void addNewRoleCommon(String Description) throws IOException, InterruptedException {
		...
		addNewRole.typeToDescriptionFieldParam(Description);// taking inputs from the description
	...
	public void enter_then_clear_the_text_into_description_input_field() throws IOException, InterruptedException{
		...
		addNewRole.typeAndClearDescriptionFieldParam("");//clear the text
		//addNewRole.clickONSubmitButton(); //click on submit button
	...
	public void enter_then_undo_the_input_action_into_description_input_field() throws IOException, InterruptedException{
		...
		addNewRole.typeToDisplayNameFieldParam("Anika Rashid");// taking input from the display Name
		addNewRole.typeToDescriptionFieldParam("description for add new role in admin panel");// taking inputs from the description
		addNewRole.typeAndClearDescriptionFieldParam("");//undo the text
		//addNewRole.clickONSubmitButton(); //click on submit button
	}
	...
	public void enter_then_undo_and_redo_the_input_action_into_description_input_field() throws IOException, InterruptedException{
		...
		addNewRole.typeToDescriptionFieldParam("description for add new role in admin panel");// taking inputs from the description
		addNewRole.typeAndClearDescriptionFieldParam("");//undo the text
		addNewRole.typeToDescriptionFieldParam("description for add new role in admin panel");//redo the text
		//addNewRole.clickONSubmitButton(); //click on submit button
	}
	...
	public void enter_text_and_navigate_through_into_description_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		addNewRole.typeToDisplayNameFieldParam("Anika Rashid");// taking input from the display Name
		addNewRole.typeToDescriptionFieldParam("description for add new role in admin panel");// taking inputs from the description
		addNewRole.typetoDescriptiontabKey();//navigate to the tab key
		//addNewRole.clickONSubmitButton(); //click on submit button
	}
