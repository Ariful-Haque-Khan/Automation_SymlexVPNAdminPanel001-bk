...
public class AppHomeBanneriOSFieldTest extends TestBase{
	...
	public void AddNewBannerCommon(String banner_iOS) throws IOException, InterruptedException {
		...
		addNewBanner.typeToAndroidOnclickURLElementFieldParam("");// taking input from the Android Onclick URL
		addNewBanner.typeToHomeBanneriOSElementFieldParam(banner_iOS);// taking input from the App Home Banner iOS
	...
	public void enter_text_then_clear_the_input_text_field() throws IOException, InterruptedException{
		...
		addNewBanner.typeAndClearHomeBanneriOSElementFieldParam("");//clear the text
		addNewBanner.typeToiOSOnclickURLElementFieldParam("url for ios");// taking input from the iOS Onclick URL
		addNewBanner.typeToResellerPanelBannerFieldParam("banner for reseller");//taking input from the Reseller Panel Banner
		addNewBanner.typeToResellerOnclickFieldParam("url for reseller");// taking input from the Reseller panel Onclick URL
		addNewBanner.selectDatafromCountryDropDownElement();// select inputs data form the Reseller drop down field
	...
	public void enter_then_undo_the_input_action_into_App_Home_Banner_iOS_input_field() throws IOException, InterruptedException{
		...
		addNewBanner.typeToAndroidOnclickURLElementFieldParam("");// taking input from the Android Onclick URL
		addNewBanner.typeToHomeBanneriOSElementFieldParam("banner for ios");// taking input from the App Home Banner iOS
		addNewBanner.typeAndClearHomeBanneriOSElementFieldParam("");//undo the text
		addNewBanner.typeToiOSOnclickURLElementFieldParam("url for ios");// taking input from the iOS Onclick URL
		addNewBanner.typeToResellerPanelBannerFieldParam("banner for reseller");//taking input from the Reseller Panel Banner
		addNewBanner.typeToResellerOnclickFieldParam("url for reseller");// taking input from the Reseller panel Onclick URL
		addNewBanner.selectDatafromCountryDropDownElement();// select inputs data form the Reseller drop down field
	...
	public void enter_then_undo_then_redo_the_input_action_into_App_Home_Banner_iOS_input_field() throws IOException, InterruptedException{
		...
		addNewBanner.typeToHomeBanneriOSElementFieldParam("banner for ios");// taking input from the App Home Banner iOS
		addNewBanner.typeAndClearHomeBanneriOSElementFieldParam("");//undo the text
		addNewBanner.typeToHomeBanneriOSElementFieldParam("banner for ios");//redo the text
		addNewBanner.typeToiOSOnclickURLElementFieldParam("url for ios");// taking input from the iOS Onclick URL
		addNewBanner.typeToResellerPanelBannerFieldParam("banner for reseller");//taking input from the Reseller Panel Banner
		addNewBanner.typeToResellerOnclickFieldParam("url for reseller");// taking input from the Reseller panel Onclick URL
		addNewBanner.selectDatafromCountryDropDownElement();// select inputs data form the Reseller drop down field
	...
	public void enter_text_and_navigate_through_into_App_Home_Banner_iOS_input_field_using_the_tab_key() throws IOException, InterruptedException{ 
		...
		addNewBanner.typeToAndroidOnclickURLElementFieldParam("");// taking input from the Android Onclick URL
		addNewBanner.typeToHomeBanneriOSElementFieldParam("banner for ios");// taking input from the App Home Banner iOS
		addNewBanner.typetotheHomeBanneriOSElementFieldtabKey();
		addNewBanner.typeToiOSOnclickURLElementFieldParam("url for ios");// taking input from the iOS Onclick URL
		addNewBanner.typeToResellerPanelBannerFieldParam("banner for reseller");//taking input from the Reseller Panel Banner
		addNewBanner.typeToResellerOnclickFieldParam("url for reseller");// taking input from the Reseller panel Onclick URL
		addNewBanner.selectDatafromCountryDropDownElement();// select inputs data form the Reseller drop down field
	...
	public void paste_the_text_into_App_Home_Banner_iOS_input_field_using_the_paste_action() throws IOException, InterruptedException{
		...
		addNewBanner.typeToAndroidOnclickURLElementFieldParam("");// taking input from the Android Onclick URL
		addNewBanner.typeToHomeBanneriOSElementFieldParam("banner for ios");// taking input from the App Home Banner iOS
		addNewBanner.typeAndClearHomeBanneriOSElementFieldParam("");
		addNewBanner.typeToiOSOnclickURLElementFieldParam("url for ios");// taking input from the iOS Onclick URL
		addNewBanner.typeToResellerPanelBannerFieldParam("banner for reseller");//taking input from the Reseller Panel Banner
		addNewBanner.typeToResellerOnclickFieldParam("url for reseller");// taking input from the Reseller panel Onclick URL
		addNewBanner.selectDatafromCountryDropDownElement();// select inputs data form the Reseller drop down field
