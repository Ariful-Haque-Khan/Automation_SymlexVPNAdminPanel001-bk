...
public class ServerRequestForm extends TestBase {
	...
	public void request_for_the_server_from_website() throws IOException, InterruptedException {
		...
		js.executeScript("window.scrollBy(0, 2700);"); // Scroll down by 3000 pixels vertically
		...
		preferableLocation.sendKeys("china");//taking input for the Preferable Location field
