...
public class ResellerPINReportsSectionLinks extends TestBase{
	...
	public ResellerPINReportsSectionLinks(){
		PageFactory.initElements(driver, this);
	}
	
	//01. Click on IP Management Drop Down
	public ResellerPINReportsSectionLinks clickOnIPManagementDropDownLink() {
		ratesSectionDropdown.click();
		return new ResellerPINReportsSectionLinks();
	}
	//02. Click on IP List page Link
	public ResellerPINReportsSectionLinks clickOnIPListLink() {
		addNewRatePlanPageLink.click();
		return new ResellerPINReportsSectionLinks();
	}
	
	//03. Click on IP Bundle page Link
	public ResellerPINReportsSectionLinks clickOnIPBundleLink() {
		ratePlanPageLink.click();
		return new ResellerPINReportsSectionLinks();
	}
	
	//04. Click on Assign to Batch Drop Down
	public ResellerPINReportsSectionLinks clickOnAssigntoBatchLink() {
		assigntoBatchPageLink.click();
		return new ResellerPINReportsSectionLinks();
	}
	//05. Click on New Block Record page Link
	public ResellerPINReportsSectionLinks clickOnNewBlockRecordLink() {
		newBlockRecordPageLink.click();
		return new ResellerPINReportsSectionLinks();
	}
	
	//06. Click on IP Block History List page Link
	public ResellerPINReportsSectionLinks clickOnIPBlockHistoryLink() {
		ipBlockHistoryPageLink.click();
		return new ResellerPINReportsSectionLinks();
	}
	
	//07. Click on Server Lock Schedules List page Link
	public ResellerPINReportsSectionLinks clickOnServerLockSchedulesPlanLink() {
