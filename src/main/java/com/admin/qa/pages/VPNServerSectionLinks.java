...
public class VPNServerSectionLinks extends TestBase{
	...
	public VPNServerSectionLinks clickOnIPManagementDropDownLink() {
		ratesSectionDropdown.click();
		return new VPNServerSectionLinks();
	}
	//02. Click on IP List page Link
	public VPNServerSectionLinks clickOnIPListLink() {
		addNewRatePlanPageLink.click();
		return new VPNServerSectionLinks();
	}
	
	//03. Click on IP Bundle page Link
	public VPNServerSectionLinks clickOnIPBundleLink() {
		ratePlanPageLink.click();
		return new VPNServerSectionLinks();
	}
	
	//04. Click on Assign to Batch Drop Down
	public VPNServerSectionLinks clickOnAssigntoBatchLink() {
		assigntoBatchPageLink.click();
		return new VPNServerSectionLinks();
	}
	//05. Click on New Block Record page Link
	public VPNServerSectionLinks clickOnNewBlockRecordLink() {
		newBlockRecordPageLink.click();
		return new VPNServerSectionLinks();
	}
	
	//06. Click on IP Block History List page Link
	public VPNServerSectionLinks clickOnIPBlockHistoryLink() {
		ipBlockHistoryPageLink.click();
		return new VPNServerSectionLinks();
	}
	
	//07. Click on Server Lock Schedules List page Link
	public VPNServerSectionLinks clickOnServerLockSchedulesPlanLink() {
