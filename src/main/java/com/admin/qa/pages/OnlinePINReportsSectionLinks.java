...
public class OnlinePINReportsSectionLinks extends TestBase{
	...
	public OnlinePINReportsSectionLinks clickOnIPListLink() {
		addNewRatePlanPageLink.click();
		return new OnlinePINReportsSectionLinks();
	}
	
	//03. Click on IP Bundle page Link
	public OnlinePINReportsSectionLinks clickOnIPBundleLink() {
		ratePlanPageLink.click();
		return new OnlinePINReportsSectionLinks();
	}
	
	//04. Click on Assign to Batch Drop Down
	public OnlinePINReportsSectionLinks clickOnAssigntoBatchLink() {
		assigntoBatchPageLink.click();
		return new OnlinePINReportsSectionLinks();
	}
	//05. Click on New Block Record page Link
	public OnlinePINReportsSectionLinks clickOnNewBlockRecordLink() {
		newBlockRecordPageLink.click();
		return new OnlinePINReportsSectionLinks();
	}
	
	//06. Click on IP Block History List page Link
	public OnlinePINReportsSectionLinks clickOnIPBlockHistoryLink() {
		ipBlockHistoryPageLink.click();
		return new OnlinePINReportsSectionLinks();
	}
	
	//07. Click on Server Lock Schedules List page Link
	public OnlinePINReportsSectionLinks clickOnServerLockSchedulesPlanLink() {
