...
import com.admin.qa.pages.ResellerListPage;
...
public class PageLinks extends TestBase{
	...
	public  ResellerListPage clickOnResellerDropDown() {
		clientDropDownLink.click();
		return new ResellerListPage();
	}
	
	public  ResellerListPage clickOnResellerLink() {
