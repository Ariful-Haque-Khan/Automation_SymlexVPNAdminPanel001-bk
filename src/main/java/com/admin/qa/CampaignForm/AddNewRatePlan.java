...
public class AddNewRatePlan extends TestBase{
	...
	public Blank openAddNewRatePlanPage() {
	...
	//01. Rate Plan Name Element
	@FindBy(xpath="/html/body/div[2]/div/section[2]/div/form/div/div[1]/div[2]/div[1]/div/input")
	WebElement typeinRatePlanNameElement;
	
	//01. Highlight the Rate Plan Name Input Field
	public void ratePlanNameElementdHighlight() throws InterruptedException {
		if (driver instanceof JavascriptExecutor) {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", typeinRatePlanNameElement);/* make a yellow border outside edge of the element */
			Thread.sleep(1000);
			js.executeScript("arguments[0].setAttribute('style', '');", typeinRatePlanNameElement);/* make a yellow border off outside edge of the element */
			Thread.sleep(1000);
			js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", typeinRatePlanNameElement);/* make a yellow border outside edge of the element */
			Thread.sleep(2000);
			js.executeScript("arguments[0].setAttribute('style', '');", typeinRatePlanNameElement);/* make a yellow border off outside edge of the element */
	...
	//01. Type To Rate Plan Name
	public AddNewRatePlan selectDatafromAppNameDropDownElement() throws InterruptedException {
		ratePlanNameElementdHighlight();/* highlight the element of the tested. */
		typeinRatePlanNameElement.sendKeys("Mob");/*type on the input field */
	...
	/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	 						* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
							* $$$$$$$$$$$$$$$$$$$$$    Start No.02 -   Element of Description Input Text Field   $$$$$$$$$$$$$$$$$$$$
							* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ 
													*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/

	//02. Element of Description Input Text Field
	@FindBy(xpath="/html/body/div[2]/div/section[2]/div/form/div/div[1]/div[2]/div[2]/div/textarea")
	WebElement descriptionInputTextFieldElement;
	...
	public void gatewayBankInputTextFieldHighlight() throws InterruptedException {
		if (driver instanceof JavascriptExecutor) {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", descriptionInputTextFieldElement);/* make a yellow border outside edge of the element */
			Thread.sleep(1000);
			js.executeScript("arguments[0].setAttribute('style', '');", descriptionInputTextFieldElement);/*make a yellow border off outside edge of the element*/
			Thread.sleep(1000);
			js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", descriptionInputTextFieldElement);/* make a yellow border outside edge of the element */
			Thread.sleep(2000);
			js.executeScript("arguments[0].setAttribute('style', '');", descriptionInputTextFieldElement);/* make a yellow border off outside edge of the element */
	...
	//02. Type to the Description Input Text Field
	public AddNewRatePlan typeToDescriptionInputTextField() throws InterruptedException {
		gatewayBankInputTextFieldHighlight();
		descriptionInputTextFieldElement.sendKeys("Test");
		return new AddNewRatePlan();
	}
	
	/***************************************************
							* *******************************************************************************************************
							* **************************    End No.02 - Element of Description Input Text Field    **********************
							* * *****************************************************************************************************
														****************************************************************************************************/
	...
	public AddNewRatePlan checkStatusInputCheckBoxField() throws InterruptedException {
	...
	//04. Type to the Submit Button Field
	public AddNewRatePlan clickOnSubmitButtonField() throws InterruptedException {
