...
public class AdBannerListElement extends TestBase{
	public AdBannerListElement(){
		PageFactory.initElements(driver, this);
	}
	
	public AdBannerListElement openAddNewBannerFormPage() {
		driver.get(props.getProperty("url")+"push/addNewBanner");
		return new AdBannerListElement();
	}
	...
	//1.0.1  Type to the Banner Name
	public AdBannerListElement  typeToBannerNameInputFieldParam(String banner_name) throws InterruptedException {
		bannerNameInputFieldHighlight();
		bannerNameElement.sendKeys(banner_name);
		return new AdBannerListElement ();
	}
	
	//1.0.2. Type Message Input Field (enter text, then clear Message Input Field)
	public AdBannerListElement typeAndClearBannerNameInputFieldParam(String banner_name) throws InterruptedException {
		bannerNameInputFieldHighlight();
		bannerNameElement.sendKeys(banner_name);
		Thread.sleep(100);
		bannerNameElement.clear();
		return new AdBannerListElement ();									    			
	}		
		
	//1.0.3. Type to Message Input Field
	public AdBannerListElement  typetotheurlforBannerNameInputFieldtabKey() throws InterruptedException {
		bannerNameInputFieldHighlight();
		bannerNameElement.sendKeys(Keys.TAB);
		return new AdBannerListElement();
	}
	...
	//02. Highlight the App Home Banner Android Element Input Field
	...
	public AdBannerListElement typeToAppHomeBannerAndroidElement() throws InterruptedException {
		appHomeBannerAndroidElementFieldHighlight();
		appHomeBannerAndroidElement.sendKeys("test");
		return new AdBannerListElement();
	}
	
	//2.0.1  Type to the App Home Banner Android Element
	public AdBannerListElement  typeToAppHomeBannerAndroidFieldParam(String banner_android) throws InterruptedException {
		appHomeBannerAndroidElementFieldHighlight();
	...
	public AdBannerListElement typeAndClearAppHomeBannerAndroidParam(String banner_android) throws InterruptedException {
		appHomeBannerAndroidElementFieldHighlight();
		appHomeBannerAndroidElement.sendKeys(banner_android);
		Thread.sleep(100);
		appHomeBannerAndroidElement.clear();
		return new AdBannerListElement ();									    			
	}		
		
	//2.0.3. Type to App Home Banner Input Field
	public AdBannerListElement  typetotheAppHomeBannerAndroidFieldtabKey() throws InterruptedException {
		appHomeBannerAndroidElementFieldHighlight();
	...
	//3.0.1  Type to the Android Onclick URL
	public AdBannerListElement  typeToAndroidOnclickURLElementFieldParam(String android_onclick_url) throws InterruptedException {
	...
	public AdBannerListElement typeAndClearOnclickURLParam(String android_onclick_url) throws InterruptedException {
		onclickURLElementFieldHighlight();
		onclickURLElement.sendKeys(android_onclick_url);
		Thread.sleep(100);
		onclickURLElement.clear();
		return new AdBannerListElement ();									    			
	}		
		
	//3.0.3. Type to Android Onclick URL Input Field
	public AdBannerListElement  typetotheOnclickURLFieldtabKey() throws InterruptedException {
		onclickURLElementFieldHighlight();
	...
	//04. Element of App Home Banner iOS
	...
	public AdBannerListElement typeToHomeBanneriOSElement() throws InterruptedException {
		homeBanneriOSElementFieldHighlight();
		homeBanneriOSElement.sendKeys("test");
		return new AdBannerListElement();
	}
	
	//4.0.1  Type to the App Home Banner iOS Element
	public AdBannerListElement  typeToHomeBanneriOSElementFieldParam(String banner_iOS) throws InterruptedException {
		homeBanneriOSElementFieldHighlight();
	...
	public AdBannerListElement typeAndClearHomeBanneriOSElementFieldParam(String banner_iOS) throws InterruptedException {
		homeBanneriOSElementFieldHighlight();
		homeBanneriOSElement.sendKeys(banner_iOS);
		Thread.sleep(100);
	...
	public AdBannerListElement  typetotheHomeBanneriOSElementFieldtabKey() throws InterruptedException {
		homeBanneriOSElementFieldHighlight();
	...
	//05. Element of App Home iOS Onclick URL Element
	...
	public AdBannerListElement typeToiOSOnclickURLElement() throws InterruptedException {
		iOSOnclickURLElementFieldHighlight();
		iOSonClickURLElement.sendKeys("test");
		return new AdBannerListElement();
	}
	
	//5.0.1  Type to the  App Home iOS Onclick URL
	public AdBannerListElement  typeToiOSOnclickURLElementFieldParam(String iOS_onclick_url) throws InterruptedException {
		iOSOnclickURLElementFieldHighlight();
	...
	public AdBannerListElement typeAndCleariOSOnclickURLElementFieldParam(String iOS_onclick_url) throws InterruptedException {
		iOSOnclickURLElementFieldHighlight();
		iOSonClickURLElement.sendKeys(iOS_onclick_url);
		Thread.sleep(100);
	...
	public AdBannerListElement  typetotheiOSOnclickURLElementFieldtabKey() throws InterruptedException {
		iOSOnclickURLElementFieldHighlight();
	...
	public AdBannerListElement typeToResellerPanelBannerElement() throws InterruptedException {
	...
	public AdBannerListElement  typeToResellerPanelBannerFieldParam(String reseller_banner) throws InterruptedException {
		resellerPanelBannerElementFieldHighlight();
	...
	public AdBannerListElement typeAndClearResellerPanelBannerFieldParam(String reseller_banner) throws InterruptedException {
		resellerPanelBannerElementFieldHighlight();
		resellerPanelBannerElement.sendKeys(reseller_banner);
		Thread.sleep(100);
	...
	public AdBannerListElement  typetotheResellerPanelBannerFieldtabKey() throws InterruptedException {
		resellerPanelBannerElementFieldHighlight();
	...
	//07. Highlight the Reseller Onclick URL  Element
	...
	public AdBannerListElement typeToResellerOnclickURLElement() throws InterruptedException {
		resellerOnclickURLElementFieldHighlight();
		reselleronClickURLElement.sendKeys("test");
		return new AdBannerListElement();
	}
	
	//7.  Type to the  Reseller Onclick URL  URL
	public AdBannerListElement  typeToResellerOnclickFieldParam(String reseller_onclick_url) throws InterruptedException {
		resellerOnclickURLElementFieldHighlight();
	...
	public AdBannerListElement typeAndClearResellerOnclickFieldParam(String reseller_onclick_url) throws InterruptedException {
		resellerOnclickURLElementFieldHighlight();
		reselleronClickURLElement.sendKeys(reseller_onclick_url);
		Thread.sleep(100);
	...
	public AdBannerListElement  typetotheResellerOnclickFieldtabKey() throws InterruptedException {
		resellerOnclickURLElementFieldHighlight();
	...
	public AdBannerListElement selectDatafromCountryDropDownElement() throws InterruptedException {
	...
	public AdBannerListElement clickOncommonPanelElement() throws InterruptedException {
		resellerOnclickURLElementFieldHighlight();
	...
	public AdBannerListElement typeToBannerRemarksElement() throws InterruptedException {
	...
	public AdBannerListElement  typeToBannerRemarksFieldParam(String remarks) throws InterruptedException {
		bannerRemarksElementFieldHighlight();
	...
	public AdBannerListElement typeAndClearBannerRemarksFieldParam(String remarks) throws InterruptedException {
		bannerRemarksElementFieldHighlight();
		bannerRemarksElement.sendKeys(remarks);
		Thread.sleep(100);
	...
	public AdBannerListElement  typetotheBannerRemarksFieldtabKey() throws InterruptedException {
		bannerRemarksElementFieldHighlight();
	...
	public AdBannerListElement clickOnLoginTypeAppElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnloginTypeAppSymlexElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnloginTypeAppPlatinumElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnUserTypeAppAllElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnUserTypeAppFreeElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnUserTypeAppExpiredElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnUserTypeAppPaidElement() throws InterruptedException {
	...
	public AdBannerListElement clickOnUserTypeAppPremiumElement() throws InterruptedException {
	...
	/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	* $$$$$$$$$$$$$$$$$$$$$$    Start No.19 -   Element of Update now button  $$$$$$$$$$$$$$$$$$$$$$$$$$
	* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ 
							*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/

    //18. Element of update now button
	@FindBy(xpath = "/html/body/div[2]/div/section[2]/div[2]/form/div/div[2]/input")
	WebElement updateNowButtonElement;

    //18. Highlight the update now button Element
	public void UpdateNowElementFieldHighlight() throws InterruptedException {
		if (driver instanceof JavascriptExecutor) {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');",updateNowButtonElement);/* make a yellow border outside edge of the element */
			Thread.sleep(1000);
			js.executeScript("arguments[0].setAttribute('style', '');",updateNowButtonElement);/* make a yellow border off outside edge of the element */
			Thread.sleep(1000);
			js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');",updateNowButtonElement);/* make a yellow border outside edge of the element */
			Thread.sleep(2000);
			js.executeScript("arguments[0].setAttribute('style', '');",updateNowButtonElement);/* make a yellow border off outside edge of the element */
    ...
    //18. Type to the update now button Element
	public AdBannerListElement clickOnUpdateNowButton() throws InterruptedException {
		UpdateNowElementFieldHighlight();
		updateNowButtonElement.click();
		return new AdBannerListElement();
	}

	/*****************************************************
	 * ************************************************************************************************
	 * ************************ End No.19 - Element of User Type(App) Premium
	 * ******************* *
	 * **********************************************************************************************
	 ********************************************************************************************************/
