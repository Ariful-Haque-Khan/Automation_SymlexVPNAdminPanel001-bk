...
public class AffiliatorSignUpRequestFromWeb extends TestBase{
	public AffiliatorSignUpRequestFromWeb(){
		PageFactory.initElements(driver, this);
	}
	
	public AddPINValidity openAffiliatorSignUpRequestFrom () {
		driver.get(props.getProperty("url")+"https://symlexvpn.com/affiliate/#aff_form");
